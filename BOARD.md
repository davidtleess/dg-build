...
| DG-139 | Served age is the model's feature-season age, not today's — 324 players a year young (255 scored); Wilson's row says 25 AND "2 years to the 28 cliff" | **2** | open — filed 09-02 15:45 by Tower (DG-130 scope side finding, re-measured); DG-137's rule applied to `age` at `universe_pvo_batch.py:198` + `roster_auditor.py:240`; plain `or` is right here (Sleeper None = unknown) | unclaimed |
