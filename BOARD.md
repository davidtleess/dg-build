...
| DG-128 | Rank everyone: the 8-game gate refuses 115 players we already have history for | 3 | todo — **David ruled 09-01: coverage fix, no slot; pre-committed taper, not tuned; the band ships with the number.** 114 of the 115 sit at `games_t` 4–7, inside the existing blend window; the fix is supplying `_dvs_a`, not widening the window. Depends on DG-127's columns being in data (09-02) | Davids-MacBook-Pro-8047 |
