...
| DG-143 | Lower the season-games gate 8 -> 4 so a player who missed most of a season still gets a number (114 unlocked) | **2** | **BUILT + PUSHED `ef08020c` on `ticket/DG-143`, NOT reviewed, NOT landed.** Market check supports it (Spearman 0.711 vs 0.795 baseline; 94% of the 82 the market ignores score <20). ⛔ DO NOT LAND until David rules on the percentile shift (mean 7.1 pts on 322 of 468 existing players). Was — David's ruling 09-03 (option A of a written either/or) + "no 'partial season' lang": the number ships BARE. Wilson 68.5 / Allen 20.5 computed and shown to him. ⚠ percentiles are population-wide — measure the shift on his 27 and the top 50 BEFORE landing. The auditor's 3.28-vs-3.19 case is REFUTED and must not be cited. | Tower |
