...
| DG-143 | Lower the season-games gate 8 -> 4 so a player who missed most of a season still gets a number (114 unlocked) | **2** | **LANDED `22d904b0` 09-03 21:5x on David's "yes land it" — NOT LIVE (trunk `6f517027`, 8 behind)**; gate comment corrected to the audited market check (`5426ffbd`); percentile side-effect put to David in plain words first | Davids-MacBook-Pro-32886 → landed by Greg |
| DG-144 | Remove the range: one number per player (David 09-03 06:22 ET: "plus or minus 20, remove it") | **6** | **LANDED `505027b5` 09-03 21:1x — NOT LIVE (trunk `6f517027`, 5 behind; David: "tomorrow is fine")** — on-screen removal only; band fields stay on the API/PVO; 5-lens/3-refuter panel, 21 findings recorded, blend caveat + width claim fixed in `b3cb7c34` | Davids-MacBook-Pro-54105 |
| DG-145 | Free agents show "FA" on the card (David 09-03 05:59 ET) | **6** | todo — assigned to Bob under David's "plan a few hours of work"; David ruled ~21:35: "FA" = nobody in the LEAGUE owns him (league free agent, from the latest roster capture) | — |
| DG-146 | A small rookie marker on the roster row (David 09-03 ~21:35 ET: "small marker indicating theyre a rookie") | **6** | todo — Greg builds; keyed on `is_prospect`, number untouched (09-01 ruling) | — |
