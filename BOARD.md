...
| DG-147 | A rookie the league did not draft gets no number and no "Rookie" word on the roster, while his card scores him | **3** | **LANDED `c7ac3484` 09-04 08:1x (Bob) — NOT LIVE**; index admits any rostered rookie row (255→263), `is_prospect` from Sleeper `years_exp`, `draft_class` served | Davids-MacBook-Pro-48631 |
