...
| DG-107 | Complete the DG-100 install sitting: register vintage-sync with the catch-up guard | **1** | todo — BUILT + pushed (`ticket/DG-107`, suite 6,518/0), holding the LAND for the backfill's first marker (landing before it exists makes the guard kick a duplicate run); plist itself BOOTSTRAPPED 08-30 07:34 (15 labels, 1 calendar slot) | ClaudeFable5-DG107-20260830 |
