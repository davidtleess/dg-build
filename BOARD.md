...
| DG-145 | Free agents show "FA" on the card (David 09-03 05:59 ET; RULED 23:35 ET: "FA" = nobody in the league owns) | **6** | doing — Bob (`davidleess-08`); built `d8c58317` on `ticket/DG-145`: card serves `league_ownership` dated by the roster capture, word minted once in copy.ts; gate green, review + land pending | — |
| DG-146 | A small rookie marker on the roster row (David 09-03 23:35 ET: "small marker indicating theyre a rookie") | **6** | doing — built `5f19ebdf` + review fixes, gate green, smoke 25/25; landing next | Davids-MacBook-Pro-54105 |
| DG-147 | A rookie the league did not draft gets no number and no "Rookie" word on the roster, while his card scores him | **3** | todo — found by the DG-146 panel 09-04; 8 such rookies league-wide, none on David's roster; in-season waiver risk | — |
